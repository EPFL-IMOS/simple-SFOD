...
from daod.data import build_detection_semisup_train_loader_two_crops
...
class AdaptiveTeacherTrainer(BaseTrainer):
    ...
    def run_step(self):
        ...
        if self.iter < self.cfg.SEMISUPNET.BURN_UP_STEP:
            ...
            if self.iter == self.cfg.SEMISUPNET.BURN_UP_STEP:
                # update teacher with copy of the whole student model
            ...
            for key in record_dict.keys():
                if key.startswith("loss") and key[-3:] != "val":
                    ...
                    elif key == "loss_DC_img_s" or key == "loss_DC_img_t":  # set weight for discriminator
